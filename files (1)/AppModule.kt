...
import com.assettrack.data.remote.GzipRequestInterceptor
...
object AppModule {
    ...
    @Provides fun provideAssetDao(db: AssetTrackDatabase): AssetDao = db.assetDao()
    @Provides fun provideTransactionDao(db: AssetTrackDatabase): TransactionDao = db.transactionDao()
    ...
    fun provideOkHttpClient(): OkHttpClient = OkHttpClient.Builder()
        ...
        // ✅ GZIP: kompres semua JSON request body 60-80%
